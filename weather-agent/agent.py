    ...
    while True:
        ...
        for msg in message_history:
            if msg["role"] == "system":
                ...
                full_prompt += f"Tool Response: {msg['content']}\n\n"
        
        full_prompt += "Please respond in the exact JSON format specified in the system prompt:\n"
        ...
        # Parse the JSON response manually since Gemini doesn't have structured output like OpenAI
        try:
            ...
            parsed_result_dict = json.loads(json_str)
            
            # Create a mock object similar to OpenAI's parsed response
            class ParsedResult:
            ...
            parsed_result = ParsedResult(parsed_result_dict)
